...
This isn't exactly an encryption algorithm, and doesn't have many uses as far as I can tell. However, it's simplicity made it interesting to me, and so I decided to make it.

*Technically, a string is converted into an (odd) integer and then multiplied by a constant, but the bulk of the math consists of a single multiplication.
