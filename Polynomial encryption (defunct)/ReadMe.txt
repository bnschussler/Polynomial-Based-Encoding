NOTE: This iteration of the project is defunct, as there is a trivial method to find the supposedly secret data (i.e. finding the zeros of the polynomial). I have left all the original files in this folder unedited (besides adding this disclaimer).
...
The files game.py and extraFunctions.py hold the entire program, and are about 40 lines in total; I encourage you to look at it, since the program isn't doing anything complicated. coeffGenerator.py allows you to make your own coefficients to replace the ones at the end of extraFunctions.py, so feel free to make your own versions of this to do whatever you want with (though if you do I'd appreciate it if you gave me credit).
